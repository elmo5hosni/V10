...
internal void LogMessageA(_In_ DWORD loglevel , _In_ char* Message , _In_ ...)
{
    ...
    _vsnprintf_s(formattedString,sizeof(formattedString),_TRUNCATE,ArgPointer);
    va_end(ArgPointer);
...
internal DWORD InitPlayer()
{
    ...
    G_Player.Position_x = 32;
    G_Player.Position_y = 32;
    G_Player.Direction = DIRECTION_DOWN;
...
{ 
    ...
    color.Red  = 0;
    color.Alpha  = 255;
    Blit_String_To_Buffer("V10 ENGINE",&G_6x7Font,100,100,&color);
